...
const ProductDetails = () => {
  ...
  const { wishlistItems, setWishlistItems } = usePIdContext();
      ...
      fetch("Data.json")
        ...
        .then((data) => {
          ...
          if (selectedGadget) {
            ...
            setIsInWishlist(
              wishlistItems.some(
                (item) => item.product_id === selectedGadget.product_id
              )
            );
          }
        });
        ...
        <div className="col-span-3 px-5">
          ...
          <div className="flex items-center gap-x-5">
            ...
            <button
              ...
              className={`w-12 h-12 border-2 border-gray-400 rounded-full flex justify-center items-center ${
                isInWishlist
